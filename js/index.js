  ...
  observeParents: true,
   ...
   $(function(){
    ...
    $('.contact-link-about').on('click',function(){
     ...
     $('.home-link').on('click',function(){
      gsap.to('.game-project',.5,{scale:.9});
      gsap.to('.game-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.game-project',0,{display:'none',delay:.7});
      gsap.to('.visual-project',.5,{scale:.9});
      gsap.to('.visual-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.visual-project',0,{display:'none',delay:.7});
      gsap.to('.render-project',.5,{scale:.9});
      gsap.to('.render-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.render-project',0,{display:'none',delay:.7});
      gsap.to('.project-project',.5,{scale:.9});
      gsap.to('.project-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.project-project',0,{display:'none',delay:.7});
      gsap.to('#about',.5,{scale:.9});
      gsap.to('#about',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#about',0,{display:'none',delay:.7});
    ...
    $('.project-project-link').on('click',function(){
      gsap.to('#home',.5,{scale:.9});
      gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#home',0,{display:'none',delay:.7});
      gsap.to('.project-project',0,{display:'block',delay:.7})
      gsap.to('.project-project',.5,{scale:1,delay:1.1})
      gsap.to('.project-name',.5,{opacity:0,delay:2.5})
      gsap.to('#breaker',{display:'block'})
      gsap.to('#breaker',0,{display:'none',delay:1.7});
    })
    $('.render-project-link').on('click',function(){
      gsap.to('#home',.5,{scale:.9});
      gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#home',0,{display:'none',delay:.7});
      gsap.to('.render-project',0,{display:'block',delay:.7})
      gsap.to('.render-project',.5,{scale:1,delay:1.1})
      gsap.to('.project-name',.5,{opacity:0,delay:2.5})
      gsap.to('#breaker',{display:'block'})
      gsap.to('#breaker',0,{display:'none',delay:1.7});
    })
    $('.visual-project-link').on('click',function(){
      gsap.to('#home',.5,{scale:.9});
      gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#home',0,{display:'none',delay:.7});
      gsap.to('.visual-project',0,{display:'block',delay:.7})
      gsap.to('.visual-project',.5,{scale:1,delay:1.1})
      gsap.to('.project-name',.5,{opacity:0,delay:2.5})
      gsap.to('#breaker',{display:'block'})
      gsap.to('#breaker',0,{display:'none',delay:1.7});
    })
    $('.game-project-link').on('click',function(){
      gsap.to('#home',.5,{scale:.9});
      gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#home',0,{display:'none',delay:.7});
      gsap.to('.game-project',0,{display:'block',delay:.7})
      gsap.to('.game-project',.5,{scale:1,delay:1.1})
      gsap.to('.project-name',.5,{opacity:0,delay:2.5})
      gsap.to('#breaker',{display:'block'})
      gsap.to('#breaker',0,{display:'none',delay:1.7});
    })
    ...
    $('.render-close').on('click',function(){
      gsap.to('.render-project',.5,{scale:.9});
      gsap.to('.render-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.render-project',0,{display:'none',delay:.7});
      gsap.to('#home',0,{display:'block',delay:.7})
